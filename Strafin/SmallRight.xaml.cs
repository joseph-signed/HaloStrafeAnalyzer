...
namespace Strafin
{
    public partial class SmallRight : Window
    {
        ...
        private void gamepadUpdate()
        {
            ...
            Dispatcher.Invoke(() =>
            {
                if (gamepad.Update())
                {
                    ...
                    double transformedX = 0 + (gamepad.right_x * 0.6);
                    double transformedY = 75 - (gamepad.right_y * 0.6);
        ...
        void SmallRight_Closing(object sender, CancelEventArgs e)
        {
            _open = false;
        }
    }
