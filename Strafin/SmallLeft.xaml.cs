...
namespace Strafin
{
    public partial class SmallLeft : Window
    {
        private readonly Timer _timer;
        static public double oldX = 0;
        static public double oldY = 75;
        static public Line? aLine;
        static public int iter = 15;
        ...
        private void gamepadUpdate()
        {
            ...
            Dispatcher.Invoke(() =>
            {
                if (gamepad.Update())
                {
                    ...
                    double transformedX = 0 + (gamepad.left_x * 0.6);
                    double transformedY = 75 - (gamepad.left_y * 0.6);
        ...
        void SmallLeft_Closing(object sender, CancelEventArgs e)
        {
            _open = false;
        }
    }
